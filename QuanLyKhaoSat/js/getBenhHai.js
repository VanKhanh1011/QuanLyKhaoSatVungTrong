                ...
                let a = data[i]
                    ...
                    <tr>
                      ...
                      <td>${a.MaBH}</td>
                            ...
                            <td>${a.MaCT}</td>
                      <td>
                      <button class="btn btn-success deleteBH" data-id="${a.MaBH}">Xóa</button>
                      <button class="btn btn-success" 
                      ><a href="SuaBenhHai.html?id=${a.MaBH}" class="suaBH" style="color: black;text-decoration: none;">Sửa</a></button>
                      </td>
                    </tr>
