            ...
            for (var i = 0; i < data.length; i++) {
                let a = data[i]
                    ...
                    <tr>
                      ...
                      <td>${a.MaNV}</td>
                      <td>
                      <button class="btn btn-success deleteDKS" data-id=${a.MaDot}>Xóa</button>
                      <button class="btn btn-success" 
                      ><a href="SuaNhapLieu.html?id=${a.MaDot}" style="color: black;text-decoration: none;">Sửa</a></button>
                      </td>
                    </tr>
                  </tbody>
