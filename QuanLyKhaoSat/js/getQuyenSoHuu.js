            ...
            for (var i = 0; i < data.length; i++) {
                ...
                <tbody id="tbody-getQSH">
                  <tr>
                    ...
                    <td>${a.MaDot}</td>
                    <td>
                    <button class="btn btn-success deleteQSH" data-id=${a.MaSoHuu}>Xóa</button>
                    <!--<button class="btn btn-success" 
                     ><a href="SuaQuyenSoHuu.html?id=${a.MaSoHuu}" style="color: black;text-decoration: none;">Sửa</a></button>-->
                    <button class="btn btn-success" 
